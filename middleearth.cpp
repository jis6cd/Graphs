...
<pre><tt><i><font color="#9A1900">/*! \file middleearth.cpp</font></i>
<i><font color="#9A1900">    \class MiddleEarth</font></i>
<i><font color="#9A1900">    \brief A MiddleEarth class </font></i>
<i><font color="#9A1900">    </font></i>
<i><font color="#9A1900">    A MiddleEarth class that is structured off of Middle Earth from the Lord </font></i>
<i><font color="#9A1900">    of the Rings</font></i>
<i><font color="#9A1900">*/</font></i>
...
<i><font color="#9A1900">/*! \var string[]</font></i>
<i><font color="#9A1900">    \brief contains all the city names</font></i>
...
<i><font color="#9A1900">/**</font></i>
<i><font color="#9A1900"> * \brief MiddleEarth constructor</font></i>
<i><font color="#9A1900"> *</font></i>
<i><font color="#9A1900"> * MiddleEarth constructor in the class MiddleEarth</font></i>
<i><font color="#9A1900"> *  Iluvatar, the creator of Middle-Earth</font></i>
<i><font color="#9A1900"> * </font></i><font color="#009900">@param</font><i><font color="#9A1900"> xsize int</font></i>
<i><font color="#9A1900"> * </font></i><font color="#009900">@param</font><i><font color="#9A1900"> ysize int</font></i>
<i><font color="#9A1900"> * </font></i><font color="#009900">@param</font><i><font color="#9A1900"> num_cities int</font></i>
<i><font color="#9A1900"> * </font></i><font color="#009900">@param</font><i><font color="#9A1900"> seed int</font></i>
<i><font color="#9A1900"> */</font></i>
...
<i><font color="#9A1900">/** </font></i><font color="#009900">@brief</font><i><font color="#9A1900"> deconstructor</font></i>
<i><font color="#9A1900"> *</font></i>
<i><font color="#9A1900"> * MiddleEarth deconstructor in the class MiddleEarth</font></i>
<i><font color="#9A1900"> * Mi Sauron, the destructor of Middle-Earth.</font></i>
<i><font color="#9A1900"> */</font></i>
...
<i><font color="#9A1900">/*! \fn void print()</font></i>
<i><font color="#9A1900">    \brief print function</font></i>
...
<i><font color="#9A1900">/*! \fn void printTable()</font></i>
<i><font color="#9A1900">    \brief prints table</font></i>
...
<i><font color="#9A1900">/*! \fn float getDistance(string city1, string city2)</font></i>
<i><font color="#9A1900">    \brief gets the distance between two cities</font></i>
...
<i><font color="#9A1900">    \param city1 first city in string form</font></i>
<i><font color="#9A1900">    \param city2 second city in string form</font></i>
<i><font color="#9A1900">*/</font></i>
...
<i><font color="#9A1900">/*! \fn vector&lt;string&gt; getItinerary(unsigned int length)</font></i>
<i><font color="#9A1900">    \brief Returns the list of cities to travel to</font></i>
...
<font color="#008080">vector&lt;string&gt;</font> MiddleEarth<font color="#990000">::</font><b><font color="#000000">getItinerary</font></b> <font color="#990000">(</font><font color="#009900">unsigned</font> <font color="#009900">int</font> length<font color="#990000">)</font> <font color="#FF0000">{</font>
    length<font color="#990000">++;</font> <i><font color="#9A1900">/*! \var length++*/</font></i>
    <b><font color="#0000FF">if</font></b> <font color="#990000">(</font> length <font color="#990000">&gt;</font> cities<font color="#990000">.</font><b><font color="#000000">size</font></b><font color="#990000">()</font> <font color="#990000">)</font> <font color="#FF0000">{</font>
        ...
        <b><font color="#000000">exit</font></b><font color="#990000">(</font><font color="#993399">0</font><font color="#990000">);</font>
    <font color="#FF0000">}</font>
    <font color="#008080">vector&lt;string&gt;</font> itinerary<font color="#990000">;</font> <i><font color="#9A1900">/*! \var itinerary */</font></i>
    <b><font color="#0000FF">for</font></b> <font color="#990000">(</font> <font color="#009900">unsigned</font> <font color="#009900">int</font> i <font color="#990000">=</font> <font color="#993399">0</font><font color="#990000">;</font> i <font color="#990000">&lt;</font> cities<font color="#990000">.</font><b><font color="#000000">size</font></b><font color="#990000">();</font> i<font color="#990000">++</font> <font color="#990000">)</font>
